...
require "$Bin/sequence_helpers.pl";
require "$Bin/format_number.pl";

my $Config = Config::Tiny -> new();
$Config = Config::Tiny ->read("$Bin/../../Pipeline/config.ini");
#my $RNAHYBRID_EXE_DIR = "/PUBLIC/source/RNA/smallRNA/pipeline/sRNA/tools_script/PITA/Bin/RNAHybrid/RNAhybrid-2.1/src";
my $RNAddG_EXE_DIR 		= $Config->{software}->{Progs};
...
/PUBLIC/source/RNA/smallRNA/pipeline/sRNA/tools_script/PITA/lib/RNAddG_compute.pl <file>
