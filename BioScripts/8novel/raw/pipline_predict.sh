...
declare -rx SCRIPT=${0##*/}
declare -r OPTSTRING="o:i:r:t:b:s:M:cg:u:m:v:p:n:k:h"
declare SWITCH
declare genome 
declare species=""
...
cpath=`dirname $0`
perlExec=`readIni $cpath/../../Pipeline/config.ini srnaenv perl_v5182`
bowtie=`readIni $cpath/../../Pipeline/config.ini software bowtie1`
MIREVO=`readIni $cpath/../../Pipeline/config.ini software miREvo`
RNAfold=`readIni $cpath/../../Pipeline/config.ini software RNAfold`
randfold=`readIni $cpath/../../Pipeline/config.ini software randfold`
...
known_mature_new=predict.$PROJNAME.`basename $known_mature`
...
other_mature_new=predict.$PROJNAME.`basename $other_mature`
