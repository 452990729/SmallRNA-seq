...
##2014/01/14 v2  modify by wangshaobin
use strict;
use warnings;
use Getopt::Long;
use FindBin '$Bin';
#my $Bin="/PUBLIC/source/RNA/smallRNA/version3/1QC/QC_report/fancybox/";
sub usage{
print STDERR <<USAGE;
=========================================================================
...
[mandatory parameters]
	...
	-mapfile <s>	mapfile  2column: "Library\tSampleName"
[optional parameters]
	-o	out_directory[default="pwd/QC_results"]
...
my $pwd = `pwd`;
$pwd =~ s/\s+//g;
$out||="$dir/$contractId\_QC_results";
...
for my $i(@sample)
{
    ...
    #`cp $dir/$i/clean_data/$i.raw_Error.txt $out/results/1RawData_ErrorRate/$i\_error_rate_distribution.txt`;
