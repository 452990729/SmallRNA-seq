...
print "\n$perlExec $Bin/diffsum.pl  -diffdir $pwd/diffAnalysisResult && \n";
print "mv $pwd/diffAnalysisResult/diff_sum.txt $pwd/diff_sum.txt && \n";
print "cat $dir/*vs*/*.DElist.txt|sort|uniq > $pwd/ALL.DElist.txt && \n";
close(OUT2);
