...
print "date +\"%D %T -> Finish diff analysis \" && \\\n";
print "cd $pwd && \\\n";
print "$perlExec $Bin/sRNA_merge_readcount.pl $rc $dir/merged $group $groupname && \n\n";
print "\n### Density, boxplot, corr plot, cluster (Hcluster,Kmeans,SOM)\n";
print "$perlExec $Bin/plot_single.R.v2.pl -rc $dir/merged.readcount -mean_rc $dir/meanscount.txt -tpm $dir/merged.tpm -mean_tpm $dir/meanstpm.txt -compare $dir/compare.txt -output $dir -cluster $samples\n\n";
