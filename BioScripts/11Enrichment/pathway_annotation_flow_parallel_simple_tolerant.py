...
settings.configure(DEBUG=True, TEMPLATE_DEBUG=True, TEMPLATE_DIRS=(BASE_DIR,))
...
config.read('{}/../../BioModule/Settings/config.ini'.format(BASE_DIR))
...
if __name__ == '__main__':
    ...
    assert not os.system('cp -rf %s .' % ( BASE_DIR + '/src'))
