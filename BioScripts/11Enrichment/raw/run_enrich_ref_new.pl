...
print OUT_KEGG "$perlExec $Bin/runKEGG.pl  -directory-gtf $gtf -gene-id $com.diffmiRNA-geneid -exist-genome y -directory-kobas-output $pwd/$com/Pathway/ -directory-genome $genome -species $species -samplename $com\n";
print OUT_KEGG "export PATH=$R_v2153:\$PATH\n";
print OUT_KEGG "export LD_LIBRARY_PATH=$LIBRARY_PATH/R_v2153:\$LD_LIBRARY_PATH\n";
print OUT_KEGG "PYTHONPATH=$Site_Packages:$kobas_v20140801/src:$kobas_v20120208/src:$kobas:\$PYTHONPATH\n";
